...
function alignErrorMassage(smallEl, inputEl) {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function setupCharCountLayout() {
        ...
        let wrapper = label.querySelector('[data-wrapper="pasen-wrapper"]');
    ...
    function applyResponsiveLayout() {
        const label = document.querySelector('label[for="txtPesan"]');
        const span = label?.querySelector('span');
        const wrapper = label?.querySelector('[date-wrapper="pesan-wrapper"]');
        const counter = document.getElementById('charCount');
